...
REAL ::                                                                     &
  ...
  denit_ratio_n2_zero = 10.0,                                               &
    ! Ratio of N in soil nitrate to amount denitrified at or below which N2
    ! emission is zero and all denitrified N is lost as N2O.
  ...
  denit_bio_factor    = 50.0
    ...
    ! Note that units are the reciprocal of those of CO2+CH4.
